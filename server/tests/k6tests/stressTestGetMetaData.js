...
export default function () {
  const BASE_URL = 'http://localhost:3003/reviews/meta/';

  const responses = http.batch([
    ['GET', `${BASE_URL}?product_id=3`, null, { }],
    ['GET', `${BASE_URL}?product_id=20`, null, { }],
    ['GET', `${BASE_URL}?product_id=2`, null, { }],
    ['GET', `${BASE_URL}?product_id=900000`, null, { }],
  ]);
