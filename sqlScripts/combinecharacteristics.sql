...
SELECT characteristics_reviews.id, characteristics_csv.product_id, characteristics_reviews.characteristic_id, characteristics_csv.name, characteristics_reviews.value
